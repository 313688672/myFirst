...
- (void)setBackgroundImage:(UIImage *)backgroundImage {
    ...
    self.backGroundImgV.image = backgroundImage;
    [self sendSubviewToBack:_backGroundImgV];
}
- (UIImageView *)backGroundImgV {
    if (!_backGroundImgV) {
        UIImageView *imageView = [UIImageView new];
        imageView.frame = self.frame;//imageView.backgroundColor = [UIColor redColor];
        _backGroundImgV = imageView;
